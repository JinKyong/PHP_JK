...
<body>
    ...
    <?php
        ...
        switch($current_month){
            ...
            case 4:
            case 5:
                $weather = "img/things-to-do-auckland-spring.jpg";
                break;
            //여름
            case 6:
            case 7:
            case 8:
                $weather = "img/summer-01.jpg";
                break;
            //가을
            case 9:
            case 10:
            case 11:
                $weather = "img/autumn_drive_heather_rushton.jpg";
                break;
            //겨울
            case 12:
            case 1:
            case 2:
                $weather = "img/header-bg.jpg";
                break;
        }

    ?>

    <header style="background: url(<?php echo $weather; ?>) no-repeat center center;" >
      <div class="container">
        <div class="row">
          <div class="col-xs-6">
